...
var BASE_URL = 'https://oynayalim.herokuapp.com';
...
function getOyunlar() {
	var url = BASE_URL + '/oyunlar';
	return axios_default.a.get(url, { headers: { accessToken: '' + getAccessToken() } }).then(function (response) {
		return response.data;
	});
}
...
// CONCATENATED MODULE: ./utils/authservice.js
...
var home_Home = function (_Component) {
	...
	function Home() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = { oyunlar: [] }, _temp), _possibleConstructorReturn(_this, _ret);
	}
...
function oyun__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var oyun_Oyun = function (_Component) {
	oyun__inherits(Oyun, _Component);

	function Oyun() {
		var _temp, _this, _ret;

		oyun__classCallCheck(this, Oyun);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = oyun__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
			time: Date.now(),
			count: 10
		...
		}, _temp), oyun__possibleConstructorReturn(_this, _ret);
	}
	...
	Oyun.prototype.componentDidMount = function componentDidMount() {
	...
	Oyun.prototype.componentWillUnmount = function componentWillUnmount() {
	...
	Oyun.prototype.render = function render(_ref, _ref2) {
		var user = _ref.user;
		var time = _ref2.time,
		    count = _ref2.count;
...
var app__ref3 = Object(preact_min["h"])(oyun_Oyun, { path: '/oyun/' });
